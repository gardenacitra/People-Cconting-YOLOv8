...
while True:
    ...
    cv2.putText(frame, "IN" + " " + str(i), (60, 80), cv2.FONT_HERSHEY_COMPLEX, (0.7), (0, 255, 0), 2)
    cv2.putText(frame, "OUT" + " " + str(o), (60, 120), cv2.FONT_HERSHEY_COMPLEX, (0.7), (0, 0, 255), 2)
    cv2.putText(frame, "INSIDE" + " " + str(t), (60, 160), cv2.FONT_HERSHEY_COMPLEX, (0.7), (255, 0, 0), 2)
